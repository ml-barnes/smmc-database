...
namespace SMMC.Controllers
{
    public class PiecesController : Controller
    {
        ...
        public PiecesController(IN705_2018S2_db3shared01Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PieceId,Title,Composer,LastPerformedDate")] Piece piece)
        {
            if (id != piece.PieceId)
            {
                return NotFound();
